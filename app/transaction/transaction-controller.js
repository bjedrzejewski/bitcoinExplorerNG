                ...
                for(var j = 0; j < that.uNodes[i].vin.length; j++){
                    ...
                    (function() {
                        ...
                        TxData.get({hashValue: that.uNodes[_i].vin[_j].txid}, function (newTx) {
                            //console.log('Got a new node for (i,j) (' + _i + ',' + _j + ') :' + newTx.txid);
                            //get the originating node number
                            //get this node number -> the number is going to be dynamic based on what is already there
